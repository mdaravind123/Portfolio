...
export default function Home() {
  return (
    <div className="2xl:container mx-auto h-screen bg-green-50">
      <div className="w-[98%] mx-auto grid grid-cols-1 h-screen">
        <div className="flex flex-col">
          <header>
            <Header />
          </header>
          <main>
            <div className="flex justify-center items-center h-[87vh] m-1">
              <div className="flex justify-center item-center">
                <div className="flex flex-col justify-center item-center w-[50%]">
                  <p className="text-black text-[25px] font-[Poppins] font-normal">
                    Software Developer
                  </p>
                  <h2 className="text-black text-[48px] font-[Poppins] font-normal">
                    Hello I'm
                  </h2>
                  <h2 className="text-black text-[48px] font-[Poppins] font-normal">
                    M D Aravind
                  </h2>
                  <p className="text-black text-[20px] font-[Poppins] font-normal w-full">
                    I'm a Passionate Full Stack Developer aiming to build
                    dynamic and Interactive websites and products which helps
                    people and simplify their work
                  </p>
